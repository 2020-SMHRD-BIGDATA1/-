	...
	%>
				...
				<!-- Banner -->
					<section id="banner">
						<div class="inner">
							...
							<p>Do you want to have a healthy working life?<br />
							Please protect your spine!<br /></p>
		...
		<script>
			function log(){
				...
				window.open("login.jsp","로그인","width=500px, height=400px,top=400px,left=700px,toolbar=no,status=no,menubar=no,resizable=yes, location=no,scrollbars=no")
